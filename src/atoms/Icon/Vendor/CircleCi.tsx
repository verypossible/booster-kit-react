...
export default function CircleCi ({ className }: Icon) {
  return (
    <svg fill='currentColor' className={className} viewBox='0 0 24 24' clipRule='evenodd' strokeLinejoin='round' stroke-miterlimit='1.414'>
