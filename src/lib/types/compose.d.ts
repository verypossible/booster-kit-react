...
export function compose<F extends Function>(f: F): F // tslint:disable-line
...
export function compose<R> (
  f1: (b: any) => R, ...funcs: Function[]  // tslint:disable-line
): (...args: any[]) => R

export function compose<R>(...funcs: Function[]): (...args: any[]) => R // tslint:disable-line
