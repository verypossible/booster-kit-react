...
describe('When visiting the site', () => {
  test('And viewing the React booster Kit examples, the URL is /docs/examples', async function () {
  ...
  test('And viewing the counter, the URL is /docs/examples/counter', async function () {
